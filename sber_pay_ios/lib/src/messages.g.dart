...
class SberPayApi {
  ...
  Future<bool> initSberPay(InitConfig config) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.sber_pay_ios.SberPayApi.initSberPay';
  ...
  Future<bool> isReadyForSPaySdk() async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.sber_pay_ios.SberPayApi.isReadyForSPaySdk';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
  ...
  Future<SberPayApiPaymentStatus> payWithBankInvoiceId(PayConfig config) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.sber_pay_ios.SberPayApi.payWithBankInvoiceId';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
